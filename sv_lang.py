...
class Generic():
    ...
    def parse_str(self, gen_str):
        ...
        parameter_pattern = r'\s?(?P<name>.*?)\s?(?::)\s?(?P<type>.*)'
...
class Interface():
    ...
    def interface_end(self, line):
        ...
        tail_pattern = r";".format(self.type, self.name)
    ...
    def parse_parameter_port(self):
        ...
        if parameter_search and parameter_str is not None:
            ...
            for item in parameter_list:
                ...
                if generic.success:
                    self.if_parameters.append(generic)
        else:
